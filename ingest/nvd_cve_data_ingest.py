    ...
    for item in cve_data["CVE_Items"]:
        ...
        if record_last_modified_datetime > db_cve_last_modified_date:
            ...
            if item["impact"].get("baseMetricV3", None) is not None:
                record_cvss_v3_version = item["impact"]["baseMetricV3"]["cvssV3"][
                    "version"
                ]
                record_cvss_v3_vector_string = item["impact"]["baseMetricV3"]["cvssV3"][
                    "vectorString"
                ]
                record_cvss_v3_attack_vector = item["impact"]["baseMetricV3"]["cvssV3"][
                    "attackVector"
                ]
                record_cvss_v3_attack_complexity = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["attackComplexity"]
                record_cvss_v3_privileges_required = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["privilegesRequired"]
                record_cvss_v3_user_interaction = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["userInteraction"]
                record_cvss_v3_scope = item["impact"]["baseMetricV3"]["cvssV3"]["scope"]
                record_cvss_v3_confidentiality_impact = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["confidentialityImpact"]
                record_cvss_v3_integrity_impact = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["integrityImpact"]
                record_cvss_v3_availability_impact = item["impact"]["baseMetricV3"][
                    "cvssV3"
                ]["availabilityImpact"]
                ...
                record_base_metric_v3_exploitability_score = item["impact"][
                    "baseMetricV3"
                ]["exploitabilityScore"]
                record_base_metric_v3_impact_score = item["impact"]["baseMetricV3"][
                    "impactScore"
                ]
            else:
            ...
            if item["impact"].get("baseMetricV2"):
                record_cvss_v2_version = item["impact"]["baseMetricV2"]["cvssV2"][
                    "version"
                ]
                record_cvss_v2_vector_string = item["impact"]["baseMetricV2"]["cvssV2"][
                    "vectorString"
                ]
                record_cvss_v2_access_vector = item["impact"]["baseMetricV2"]["cvssV2"][
                    "accessVector"
                ]
                record_cvss_v2_access_complexity = item["impact"]["baseMetricV2"][
                    "cvssV2"
                ]["accessComplexity"]
                record_cvss_v2_authentication = item["impact"]["baseMetricV2"][
                    "cvssV2"
                ]["authentication"]
                record_cvss_v2_confidentiality_impact = item["impact"]["baseMetricV2"][
                    "cvssV2"
                ]["confidentialityImpact"]
                record_cvss_v2_integrity_impact = item["impact"]["baseMetricV2"][
                    "cvssV2"
                ]["integrityImpact"]
                record_cvss_v2_availability_impact = item["impact"]["baseMetricV2"][
                    "cvssV2"
                ]["availabilityImpact"]
                record_cvss_v2_base_score = item["impact"]["baseMetricV2"]["cvssV2"][
                    "baseScore"
                ]
                record_base_metric_v2_severity = item["impact"]["baseMetricV2"][
                    "severity"
                ]
                record_base_metric_v2_exploitability_score = item["impact"][
                    "baseMetricV2"
                ]["exploitabilityScore"]
                record_base_metric_v2_impact_score = item["impact"]["baseMetricV2"][
                    "impactScore"
                ]
                record_base_metric_v2_obtain_all_privilege = item["impact"][
                    "baseMetricV2"
                ]["obtainAllPrivilege"]
                record_base_metric_v2_obtain_user_privilege = item["impact"][
                    "baseMetricV2"
                ]["obtainUserPrivilege"]
                record_base_metric_v2_obtain_other_privilege = item["impact"][
                    "baseMetricV2"
                ]["obtainOtherPrivilege"]
                record_base_metric_v2_user_interaction_required = item["impact"][
                    "baseMetricV2"
                ].get("userInteractionRequired", None)
            else:
